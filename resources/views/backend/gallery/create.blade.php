...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('galleries.index') }}" class="btn btn-sm btn-secondary d-flex align-items-center gap-2 back-btn">
...
@section('content')
    ...
    <div class="card shadow-lg">
        <div class="card-body">
            <form id="galleryForm" action="{{ route('galleries.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <!-- Title -->
                    <div class="col-md-6">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}"
                            class="form-control @error('title') is-invalid @enderror" placeholder="Image Name">
                        @error('title')
